...
// Apply on Job
router.post("/apply", (0, auth_1.default)(auth_constants_1.UserRole.user, auth_constants_1.UserRole.admin, auth_constants_1.UserRole.moderator), application_controller_1.ApplicationControllers.applyOnJob);
// Withdraw
