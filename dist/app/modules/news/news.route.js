...
router.get("/trending", news_controller_1.NewsControllers.getAllTrendingNews);
router.get("/:newsId/:languageCode", news_controller_1.NewsControllers.getSingleNewsById);
...
router.patch("/toggle-like/:newsId", (0, auth_1.default)(auth_constants_1.UserRole.admin, auth_constants_1.UserRole.moderator, auth_constants_1.UserRole.user), news_controller_1.NewsControllers.toggleLikeNewsController);
...
router.patch("/toggle-trending/:newsId", (0, auth_1.default)(auth_constants_1.UserRole.admin, auth_constants_1.UserRole.moderator), news_controller_1.NewsControllers.toggleIsTrendingNews);
